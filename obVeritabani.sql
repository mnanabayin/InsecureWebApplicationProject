...
-- CREATE DATABASE "ob" ------------------------------------
CREATE DATABASE IF NOT EXISTS `ob` CHARACTER SET utf8 COLLATE utf8_turkish_ci;
USE `ob`;
-- ---------------------------------------------------------
...
CREATE TABLE `acilankurslar` ( 
	`acilanKurslarID` MediumInt( 6 ) UNSIGNED ZEROFILL AUTO_INCREMENT NOT NULL,
	...
	CONSTRAINT `acilanKurslarID` UNIQUE( `acilanKurslarID` ) )
ENGINE = InnoDB
AUTO_INCREMENT = 53;
-- ---------------------------------------------------------
...
-- CREATE TABLE "kurskatalog" ------------------------------
CREATE TABLE `kurskatalog` ( 
	`kursNo` Smallint( 3 ) UNSIGNED ZEROFILL AUTO_INCREMENT NOT NULL,
	`kursAdi` VarChar( 60 ) NOT NULL,
	`kursAlani` VarChar( 40 ) NULL,
	`kursSaati` Smallint( 4 ) NULL,
	`kursIcerik` VarChar( 300 ) NULL DEFAULT 'Bilinmiyor',
	PRIMARY KEY ( `kursNo` ) )
ENGINE = InnoDB
AUTO_INCREMENT = 46;
-- ---------------------------------------------------------
...
CREATE TABLE `merkezler` ( 
	`merkezNo` Smallint( 3 ) UNSIGNED ZEROFILL AUTO_INCREMENT NOT NULL,
	`merkezAdi` VarChar( 50 ) NOT NULL,
...
CREATE TABLE `ogrencikayit` ( 
	...
	`kursNo` MediumInt( 6 ) UNSIGNED ZEROFILL NOT NULL UNIQUE,
	...
	CONSTRAINT `kursNo` UNIQUE( `kursNo`, `ogrenciNo` ),
...
-- Dump data of "acilankurslar" ----------------------------
INSERT INTO `acilankurslar`(`acilanKurslarID`,`kursNo`,`merkezNo`,`personelNo`,`baslamaTarihi`,`bitisTarihi`,`gun`,`saat`,`kontenjan`,`durum`,`aciklama`) VALUES ( '000001', '001', '001', '00000000001', '2011-05-24', '2011-06-24', NULL, NULL, '10', 'T', '' );
INSERT INTO `acilankurslar`(`acilanKurslarID`,`kursNo`,`merkezNo`,`personelNo`,`baslamaTarihi`,`bitisTarihi`,`gun`,`saat`,`kontenjan`,`durum`,`aciklama`) VALUES ( '000036', '034', '002', '00000000001', '2011-05-11', '2011-06-18', '0', '0', '12', 'A', 'Bilinmiyor' );
INSERT INTO `acilankurslar`(`acilanKurslarID`,`kursNo`,`merkezNo`,`personelNo`,`baslamaTarihi`,`bitisTarihi`,`gun`,`saat`,`kontenjan`,`durum`,`aciklama`) VALUES ( '000037', '035', '002', '00000000001', '2011-05-24', '2011-05-24', NULL, NULL, '12', 'A', 'Bilinmiyor' );
INSERT INTO `acilankurslar`(`acilanKurslarID`,`kursNo`,`merkezNo`,`personelNo`,`baslamaTarihi`,`bitisTarihi`,`gun`,`saat`,`kontenjan`,`durum`,`aciklama`) VALUES ( '000038', '033', '006', '00000000001', '2011-05-19', '2011-06-20', NULL, NULL, '13', 'A', '' );
INSERT INTO `acilankurslar`(`acilanKurslarID`,`kursNo`,`merkezNo`,`personelNo`,`baslamaTarihi`,`bitisTarihi`,`gun`,`saat`,`kontenjan`,`durum`,`aciklama`) VALUES ( '000039', '033', '004', '00000000001', '2011-07-11', '2011-07-12', '0', '0', '14', 'A', 'Bilinmiyor' );
INSERT INTO `acilankurslar`(`acilanKurslarID`,`kursNo`,`merkezNo`,`personelNo`,`baslamaTarihi`,`bitisTarihi`,`gun`,`saat`,`kontenjan`,`durum`,`aciklama`) VALUES ( '000041', '001', '003', '00000000001', '2011-08-18', '2011-10-30', 'Pazartesi,Salı,Çarşamba', '09:00', '45', 'T', 'Bilinmiyor' );
INSERT INTO `acilankurslar`(`acilanKurslarID`,`kursNo`,`merkezNo`,`personelNo`,`baslamaTarihi`,`bitisTarihi`,`gun`,`saat`,`kontenjan`,`durum`,`aciklama`) VALUES ( '000042', '034', '003', '00000000001', '2011-08-25', '2011-09-25', 'Cumartesi, Pazar', '18:00-20:0', '15', 'A', 'Bilinmiyor' );
INSERT INTO `acilankurslar`(`acilanKurslarID`,`kursNo`,`merkezNo`,`personelNo`,`baslamaTarihi`,`bitisTarihi`,`gun`,`saat`,`kontenjan`,`durum`,`aciklama`) VALUES ( '000044', '034', '003', '00000000001', '2011-08-02', '2011-09-22', '', '', '14', 'A', 'Bilinmiyor' );
INSERT INTO `acilankurslar`(`acilanKurslarID`,`kursNo`,`merkezNo`,`personelNo`,`baslamaTarihi`,`bitisTarihi`,`gun`,`saat`,`kontenjan`,`durum`,`aciklama`) VALUES ( '000045', '034', '006', '00000000001', '2011-08-02', '2011-09-22', '', '', '16', 'T', 'Bilinmiyor' );
INSERT INTO `acilankurslar`(`acilanKurslarID`,`kursNo`,`merkezNo`,`personelNo`,`baslamaTarihi`,`bitisTarihi`,`gun`,`saat`,`kontenjan`,`durum`,`aciklama`) VALUES ( '000046', '001', '004', '00000000001', '2011-08-02', '2011-09-21', '0', '0', '18', 'T', 'Bilinmiyor' );
INSERT INTO `acilankurslar`(`acilanKurslarID`,`kursNo`,`merkezNo`,`personelNo`,`baslamaTarihi`,`bitisTarihi`,`gun`,`saat`,`kontenjan`,`durum`,`aciklama`) VALUES ( '000047', '033', '001', '00000000001', '0000-00-00', '0000-00-00', '', '', '19', 'T', 'Bilinmiyor' );
INSERT INTO `acilankurslar`(`acilanKurslarID`,`kursNo`,`merkezNo`,`personelNo`,`baslamaTarihi`,`bitisTarihi`,`gun`,`saat`,`kontenjan`,`durum`,`aciklama`) VALUES ( '000048', '035', '006', '11111111111', '2011-09-08', '2011-10-08', NULL, NULL, '20', 'A', 'Bilinmiyor' );
INSERT INTO `acilankurslar`(`acilanKurslarID`,`kursNo`,`merkezNo`,`personelNo`,`baslamaTarihi`,`bitisTarihi`,`gun`,`saat`,`kontenjan`,`durum`,`aciklama`) VALUES ( '000050', '036', '004', '11111111111', '2011-09-12', '2011-10-12', NULL, NULL, '10', 'A', 'Bilinmiyor' );
INSERT INTO `acilankurslar`(`acilanKurslarID`,`kursNo`,`merkezNo`,`personelNo`,`baslamaTarihi`,`bitisTarihi`,`gun`,`saat`,`kontenjan`,`durum`,`aciklama`) VALUES ( '000051', '036', '006', '11111111111', '2011-09-30', '2011-10-20', '0', '0', '10', 'T', 'Bilinmiyor' );
INSERT INTO `acilankurslar`(`acilanKurslarID`,`kursNo`,`merkezNo`,`personelNo`,`baslamaTarihi`,`bitisTarihi`,`gun`,`saat`,`kontenjan`,`durum`,`aciklama`) VALUES ( '000052', '045', '004', '00000000001', '2011-09-30', '2011-11-30', NULL, NULL, '40', 'A', 'Bilinmiyorrr' );
-- ---------------------------------------------------------


-- Dump data of "dersprogrami" -----------------------------
INSERT INTO `dersprogrami`(`kayitNo`,`acilanKursNo`,`saatGun`) VALUES ( '0000057', '000037', '22' );
INSERT INTO `dersprogrami`(`kayitNo`,`acilanKursNo`,`saatGun`) VALUES ( '0000058', '000037', '33' );
INSERT INTO `dersprogrami`(`kayitNo`,`acilanKursNo`,`saatGun`) VALUES ( '0000081', '000041', '12' );
INSERT INTO `dersprogrami`(`kayitNo`,`acilanKursNo`,`saatGun`) VALUES ( '0000082', '000041', '22' );
INSERT INTO `dersprogrami`(`kayitNo`,`acilanKursNo`,`saatGun`) VALUES ( '0000083', '000041', '32' );
INSERT INTO `dersprogrami`(`kayitNo`,`acilanKursNo`,`saatGun`) VALUES ( '0000084', '000041', '42' );
INSERT INTO `dersprogrami`(`kayitNo`,`acilanKursNo`,`saatGun`) VALUES ( '0000085', '000041', '52' );
INSERT INTO `dersprogrami`(`kayitNo`,`acilanKursNo`,`saatGun`) VALUES ( '0000076', '000046', '11' );
INSERT INTO `dersprogrami`(`kayitNo`,`acilanKursNo`,`saatGun`) VALUES ( '0000077', '000046', '12' );
INSERT INTO `dersprogrami`(`kayitNo`,`acilanKursNo`,`saatGun`) VALUES ( '0000078', '000046', '13' );
INSERT INTO `dersprogrami`(`kayitNo`,`acilanKursNo`,`saatGun`) VALUES ( '0000079', '000046', '14' );
INSERT INTO `dersprogrami`(`kayitNo`,`acilanKursNo`,`saatGun`) VALUES ( '0000080', '000046', '15' );
INSERT INTO `dersprogrami`(`kayitNo`,`acilanKursNo`,`saatGun`) VALUES ( '0000067', '000050', '11' );
INSERT INTO `dersprogrami`(`kayitNo`,`acilanKursNo`,`saatGun`) VALUES ( '0000068', '000050', '13' );
INSERT INTO `dersprogrami`(`kayitNo`,`acilanKursNo`,`saatGun`) VALUES ( '0000069', '000050', '15' );
INSERT INTO `dersprogrami`(`kayitNo`,`acilanKursNo`,`saatGun`) VALUES ( '0000070', '000050', '21' );
INSERT INTO `dersprogrami`(`kayitNo`,`acilanKursNo`,`saatGun`) VALUES ( '0000071', '000050', '23' );
INSERT INTO `dersprogrami`(`kayitNo`,`acilanKursNo`,`saatGun`) VALUES ( '0000072', '000050', '25' );
INSERT INTO `dersprogrami`(`kayitNo`,`acilanKursNo`,`saatGun`) VALUES ( '0000073', '000050', '31' );
INSERT INTO `dersprogrami`(`kayitNo`,`acilanKursNo`,`saatGun`) VALUES ( '0000074', '000050', '33' );
INSERT INTO `dersprogrami`(`kayitNo`,`acilanKursNo`,`saatGun`) VALUES ( '0000075', '000050', '35' );
INSERT INTO `dersprogrami`(`kayitNo`,`acilanKursNo`,`saatGun`) VALUES ( '0000086', '000051', '11' );
INSERT INTO `dersprogrami`(`kayitNo`,`acilanKursNo`,`saatGun`) VALUES ( '0000087', '000051', '13' );
INSERT INTO `dersprogrami`(`kayitNo`,`acilanKursNo`,`saatGun`) VALUES ( '0000088', '000051', '15' );
INSERT INTO `dersprogrami`(`kayitNo`,`acilanKursNo`,`saatGun`) VALUES ( '0000089', '000051', '21' );
INSERT INTO `dersprogrami`(`kayitNo`,`acilanKursNo`,`saatGun`) VALUES ( '0000090', '000051', '23' );
INSERT INTO `dersprogrami`(`kayitNo`,`acilanKursNo`,`saatGun`) VALUES ( '0000091', '000051', '25' );
INSERT INTO `dersprogrami`(`kayitNo`,`acilanKursNo`,`saatGun`) VALUES ( '0000092', '000052', '11' );
INSERT INTO `dersprogrami`(`kayitNo`,`acilanKursNo`,`saatGun`) VALUES ( '0000093', '000052', '13' );
INSERT INTO `dersprogrami`(`kayitNo`,`acilanKursNo`,`saatGun`) VALUES ( '0000094', '000052', '15' );
INSERT INTO `dersprogrami`(`kayitNo`,`acilanKursNo`,`saatGun`) VALUES ( '0000095', '000052', '32' );
INSERT INTO `dersprogrami`(`kayitNo`,`acilanKursNo`,`saatGun`) VALUES ( '0000096', '000052', '34' );
-- ---------------------------------------------------------


-- Dump data of "duyurular" --------------------------------
INSERT INTO `duyurular`(`duyuruNo`,`personelNo`,`konu`,`eklemeTarihi`,`sonTarihi`,`icerik`) VALUES ( '2', '00000000001', 'Kursu kayıtları başlamıştır...', '2011-01-01', '2011-01-01', '2011-01-01' );
INSERT INTO `duyurular`(`duyuruNo`,`personelNo`,`konu`,`eklemeTarihi`,`sonTarihi`,`icerik`) VALUES ( '3', '00000000001', ' Kursu kayıtları başlamıştır...', '2011-02-02', '2011-02-02', '2011-2-2' );
INSERT INTO `duyurular`(`duyuruNo`,`personelNo`,`konu`,`eklemeTarihi`,`sonTarihi`,`icerik`) VALUES ( '4', '00000000002', 'Bilgisayar İşletmenlik kursu açılıyor', '2011-02-02', '2011-02-02', '' );
...
INSERT INTO `ilceler`(`ilceKodu`,`il`,`ilceAdi`) VALUES ( '001', '01', 'Merkez' );
...
INSERT INTO `ilceler`(`ilceKodu`,`il`,`ilceAdi`) VALUES ( '015', '02', 'Merkez' );
...
INSERT INTO `ilceler`(`ilceKodu`,`il`,`ilceAdi`) VALUES ( '024', '03', 'Merkez' );
...
INSERT INTO `ilceler`(`ilceKodu`,`il`,`ilceAdi`) VALUES ( '042', '04', 'Merkez' );
...
INSERT INTO `ilceler`(`ilceKodu`,`il`,`ilceAdi`) VALUES ( '050', '05', 'Merkez' );
...
INSERT INTO `ilceler`(`ilceKodu`,`il`,`ilceAdi`) VALUES ( '057', '06', 'Merkez' );
...
INSERT INTO `ilceler`(`ilceKodu`,`il`,`ilceAdi`) VALUES ( '082', '07', 'Merkez' );
...
INSERT INTO `ilceler`(`ilceKodu`,`il`,`ilceAdi`) VALUES ( '098', '08', 'Merkez' );
...
INSERT INTO `ilceler`(`ilceKodu`,`il`,`ilceAdi`) VALUES ( '106', '09', 'Merkez' );
...
INSERT INTO `ilceler`(`ilceKodu`,`il`,`ilceAdi`) VALUES ( '123', '10', 'Merkez' );
...
INSERT INTO `ilceler`(`ilceKodu`,`il`,`ilceAdi`) VALUES ( '143', '11', 'Merkez' );
...
INSERT INTO `ilceler`(`ilceKodu`,`il`,`ilceAdi`) VALUES ( '151', '12', 'Merkez' );
...
INSERT INTO `ilceler`(`ilceKodu`,`il`,`ilceAdi`) VALUES ( '159', '13', 'Merkez' );
...
INSERT INTO `ilceler`(`ilceKodu`,`il`,`ilceAdi`) VALUES ( '166', '14', 'Merkez' );
...
INSERT INTO `ilceler`(`ilceKodu`,`il`,`ilceAdi`) VALUES ( '175', '15', 'Merkez' );
...
INSERT INTO `ilceler`(`ilceKodu`,`il`,`ilceAdi`) VALUES ( '186', '16', 'Merkez' );
...
INSERT INTO `ilceler`(`ilceKodu`,`il`,`ilceAdi`) VALUES ( '204', '17', 'Merkez' );
...
INSERT INTO `ilceler`(`ilceKodu`,`il`,`ilceAdi`) VALUES ( '216', '18', 'Merkez' );
...
INSERT INTO `ilceler`(`ilceKodu`,`il`,`ilceAdi`) VALUES ( '224', '18', 'Kursunlu' );
...
INSERT INTO `ilceler`(`ilceKodu`,`il`,`ilceAdi`) VALUES ( '229', '19', 'Merkez' );
...
INSERT INTO `ilceler`(`ilceKodu`,`il`,`ilceAdi`) VALUES ( '243', '20', 'Merkez' );
...
INSERT INTO `ilceler`(`ilceKodu`,`il`,`ilceAdi`) VALUES ( '262', '21', 'Merkez' );
...
INSERT INTO `ilceler`(`ilceKodu`,`il`,`ilceAdi`) VALUES ( '276', '22', 'Merkez' );
...
INSERT INTO `ilceler`(`ilceKodu`,`il`,`ilceAdi`) VALUES ( '285', '23', 'Merkez' );
...
INSERT INTO `ilceler`(`ilceKodu`,`il`,`ilceAdi`) VALUES ( '296', '24', 'Merkez' );
...
INSERT INTO `ilceler`(`ilceKodu`,`il`,`ilceAdi`) VALUES ( '305', '25', 'Merkez' );
...
INSERT INTO `ilceler`(`ilceKodu`,`il`,`ilceAdi`) VALUES ( '324', '26', 'Merkez' );
...
INSERT INTO `ilceler`(`ilceKodu`,`il`,`ilceAdi`) VALUES ( '337', '27', 'Merkez' );
...
INSERT INTO `ilceler`(`ilceKodu`,`il`,`ilceAdi`) VALUES ( '348', '28', 'Merkez' );
...
INSERT INTO `ilceler`(`ilceKodu`,`il`,`ilceAdi`) VALUES ( '364', '29', 'Merkez' );
...
INSERT INTO `ilceler`(`ilceKodu`,`il`,`ilceAdi`) VALUES ( '370', '30', 'Merkez' );
...
INSERT INTO `ilceler`(`ilceKodu`,`il`,`ilceAdi`) VALUES ( '374', '31', 'Merkez' );
...
INSERT INTO `ilceler`(`ilceKodu`,`il`,`ilceAdi`) VALUES ( '386', '32', 'Merkez' );
...
INSERT INTO `ilceler`(`ilceKodu`,`il`,`ilceAdi`) VALUES ( '399', '33', 'Merkez' );
...
INSERT INTO `ilceler`(`ilceKodu`,`il`,`ilceAdi`) VALUES ( '409', '34', 'Merkez' );
...
INSERT INTO `ilceler`(`ilceKodu`,`il`,`ilceAdi`) VALUES ( '443', '35', 'Merkez' );
...
INSERT INTO `ilceler`(`ilceKodu`,`il`,`ilceAdi`) VALUES ( '472', '36', 'Merkez' );
...
INSERT INTO `ilceler`(`ilceKodu`,`il`,`ilceAdi`) VALUES ( '480', '37', 'Merkez' );
...
INSERT INTO `ilceler`(`ilceKodu`,`il`,`ilceAdi`) VALUES ( '500', '38', 'Merkez' );
...
INSERT INTO `ilceler`(`ilceKodu`,`il`,`ilceAdi`) VALUES ( '517', '39', 'Merkez' );
...
INSERT INTO `ilceler`(`ilceKodu`,`il`,`ilceAdi`) VALUES ( '525', '40', 'Merkez' );
...
INSERT INTO `ilceler`(`ilceKodu`,`il`,`ilceAdi`) VALUES ( '532', '41', 'Merkez' );
...
INSERT INTO `ilceler`(`ilceKodu`,`il`,`ilceAdi`) VALUES ( '539', '42', 'Merkez' );
...
INSERT INTO `ilceler`(`ilceKodu`,`il`,`ilceAdi`) VALUES ( '571', '43', 'Merkez' );
...
INSERT INTO `ilceler`(`ilceKodu`,`il`,`ilceAdi`) VALUES ( '584', '44', 'Merkez' );
...
INSERT INTO `ilceler`(`ilceKodu`,`il`,`ilceAdi`) VALUES ( '598', '45', 'Merkez' );
...
INSERT INTO `ilceler`(`ilceKodu`,`il`,`ilceAdi`) VALUES ( '614', '46', 'Merkez' );
...
INSERT INTO `ilceler`(`ilceKodu`,`il`,`ilceAdi`) VALUES ( '624', '47', 'Merkez' );
...
INSERT INTO `ilceler`(`ilceKodu`,`il`,`ilceAdi`) VALUES ( '634', '48', 'Merkez' );
...
INSERT INTO `ilceler`(`ilceKodu`,`il`,`ilceAdi`) VALUES ( '646', '49', 'Merkez' );
...
INSERT INTO `ilceler`(`ilceKodu`,`il`,`ilceAdi`) VALUES ( '652', '50', 'Merkez' );
...
INSERT INTO `ilceler`(`ilceKodu`,`il`,`ilceAdi`) VALUES ( '660', '51', 'Merkez' );
...
INSERT INTO `ilceler`(`ilceKodu`,`il`,`ilceAdi`) VALUES ( '666', '52', 'Merkez' );
...
INSERT INTO `ilceler`(`ilceKodu`,`il`,`ilceAdi`) VALUES ( '685', '53', 'Merkez' );
...
INSERT INTO `ilceler`(`ilceKodu`,`il`,`ilceAdi`) VALUES ( '697', '54', 'Merkez' );
...
INSERT INTO `ilceler`(`ilceKodu`,`il`,`ilceAdi`) VALUES ( '710', '55', 'Merkez' );
...
INSERT INTO `ilceler`(`ilceKodu`,`il`,`ilceAdi`) VALUES ( '725', '56', 'Merkez' );
...
INSERT INTO `ilceler`(`ilceKodu`,`il`,`ilceAdi`) VALUES ( '733', '57', 'Merkez' );
...
INSERT INTO `ilceler`(`ilceKodu`,`il`,`ilceAdi`) VALUES ( '742', '58', 'Merkez' );
...
INSERT INTO `ilceler`(`ilceKodu`,`il`,`ilceAdi`) VALUES ( '759', '59', 'Merkez' );
...
INSERT INTO `ilceler`(`ilceKodu`,`il`,`ilceAdi`) VALUES ( '768', '60', 'Merkez' );
...
INSERT INTO `ilceler`(`ilceKodu`,`il`,`ilceAdi`) VALUES ( '780', '61', 'Merkez' );
...
INSERT INTO `ilceler`(`ilceKodu`,`il`,`ilceAdi`) VALUES ( '798', '62', 'Merkez' );
...
INSERT INTO `ilceler`(`ilceKodu`,`il`,`ilceAdi`) VALUES ( '806', '63', 'Merkez' );
...
INSERT INTO `ilceler`(`ilceKodu`,`il`,`ilceAdi`) VALUES ( '817', '64', 'Merkez' );
...
INSERT INTO `ilceler`(`ilceKodu`,`il`,`ilceAdi`) VALUES ( '823', '65', 'Merkez' );
...
INSERT INTO `ilceler`(`ilceKodu`,`il`,`ilceAdi`) VALUES ( '835', '66', 'Merkez' );
...
INSERT INTO `ilceler`(`ilceKodu`,`il`,`ilceAdi`) VALUES ( '849', '67', 'Merkez' );
...
INSERT INTO `ilceler`(`ilceKodu`,`il`,`ilceAdi`) VALUES ( '857', '68', 'Merkez' );
...
INSERT INTO `ilceler`(`ilceKodu`,`il`,`ilceAdi`) VALUES ( '864', '69', 'Merkez' );
...
INSERT INTO `ilceler`(`ilceKodu`,`il`,`ilceAdi`) VALUES ( '867', '70', 'Merkez' );
...
INSERT INTO `ilceler`(`ilceKodu`,`il`,`ilceAdi`) VALUES ( '873', '71', 'Merkez' );
...
INSERT INTO `ilceler`(`ilceKodu`,`il`,`ilceAdi`) VALUES ( '882', '72', 'Merkez' );
...
INSERT INTO `ilceler`(`ilceKodu`,`il`,`ilceAdi`) VALUES ( '888', '73', 'Merkez' );
...
INSERT INTO `ilceler`(`ilceKodu`,`il`,`ilceAdi`) VALUES ( '895', '74', 'Merkez' );
...
INSERT INTO `ilceler`(`ilceKodu`,`il`,`ilceAdi`) VALUES ( '899', '75', 'Merkez' );
...
INSERT INTO `ilceler`(`ilceKodu`,`il`,`ilceAdi`) VALUES ( '905', '76', 'Merkez' );
...
INSERT INTO `ilceler`(`ilceKodu`,`il`,`ilceAdi`) VALUES ( '909', '77', 'Merkez' );
...
INSERT INTO `ilceler`(`ilceKodu`,`il`,`ilceAdi`) VALUES ( '915', '78', 'Merkez' );
...
INSERT INTO `ilceler`(`ilceKodu`,`il`,`ilceAdi`) VALUES ( '921', '79', 'Merkez' );
...
INSERT INTO `ilceler`(`ilceKodu`,`il`,`ilceAdi`) VALUES ( '925', '80', 'Merkez' );
...
INSERT INTO `ilceler`(`ilceKodu`,`il`,`ilceAdi`) VALUES ( '932', '81', 'Merkez' );
...
-- Dump data of "kurskatalog" ------------------------------
INSERT INTO `kurskatalog`(`kursNo`,`kursAdi`,`kursAlani`,`kursSaati`,`kursIcerik`) VALUES ( '001', 'Veritabanı Yönetim Sistemleri', '', '65', '' );
INSERT INTO `kurskatalog`(`kursNo`,`kursAdi`,`kursAlani`,`kursSaati`,`kursIcerik`) VALUES ( '033', 'Web Programlama', '', '44', 'Bilinmiyoraaa' );
INSERT INTO `kurskatalog`(`kursNo`,`kursAdi`,`kursAlani`,`kursSaati`,`kursIcerik`) VALUES ( '034', 'Nesne Yönelimli Programlama', NULL, NULL, 'NYPG' );
INSERT INTO `kurskatalog`(`kursNo`,`kursAdi`,`kursAlani`,`kursSaati`,`kursIcerik`) VALUES ( '035', 'Bilgisayar Donanım', NULL, NULL, 'Bilinmiyor' );
INSERT INTO `kurskatalog`(`kursNo`,`kursAdi`,`kursAlani`,`kursSaati`,`kursIcerik`) VALUES ( '036', 'Mantıksal Devreler', NULL, NULL, 'Bilinmiyor' );
INSERT INTO `kurskatalog`(`kursNo`,`kursAdi`,`kursAlani`,`kursSaati`,`kursIcerik`) VALUES ( '045', 'Elektronik', '', '1200', '' );
-- ---------------------------------------------------------


-- Dump data of "merkezler" --------------------------------
INSERT INTO `merkezler`(`merkezNo`,`merkezAdi`,`adres`) VALUES ( '001', 'Merkez A', NULL );
INSERT INTO `merkezler`(`merkezNo`,`merkezAdi`,`adres`) VALUES ( '002', 'Merkez B', NULL );
INSERT INTO `merkezler`(`merkezNo`,`merkezAdi`,`adres`) VALUES ( '003', 'Merkez C', '' );
INSERT INTO `merkezler`(`merkezNo`,`merkezAdi`,`adres`) VALUES ( '004', 'Merkez D', NULL );
INSERT INTO `merkezler`(`merkezNo`,`merkezAdi`,`adres`) VALUES ( '005', 'Merkez E', NULL );
INSERT INTO `merkezler`(`merkezNo`,`merkezAdi`,`adres`) VALUES ( '006', 'Merkez F', NULL );
-- ---------------------------------------------------------


-- Dump data of "ogrencikayit" -----------------------------
INSERT INTO `ogrencikayit`(`ogrenciKayitID`,`kursNo`,`ogrenciNo`,`not1`,`not2`,`ortalama`,`sonuc`,`devam`,`kayitTarihi`,`aciklama`) VALUES ( '12', '000036', '00000000001', '999', '999', '5', 'Başarısız', '99', '2011-05-17', 'Bilinmiyor' );
INSERT INTO `ogrencikayit`(`ogrenciKayitID`,`kursNo`,`ogrenciNo`,`not1`,`not2`,`ortalama`,`sonuc`,`devam`,`kayitTarihi`,`aciklama`) VALUES ( '21', '000036', '30682832620', '999', '999', '44', NULL, '99', '2011-05-24', 'Bilinmiyor' );
INSERT INTO `ogrencikayit`(`ogrenciKayitID`,`kursNo`,`ogrenciNo`,`not1`,`not2`,`ortalama`,`sonuc`,`devam`,`kayitTarihi`,`aciklama`) VALUES ( '41', '000042', '00000000001', '999', '999', '22', 'Başarısız', '99', '2011-08-19', 'Bilinmiyor' );
INSERT INTO `ogrencikayit`(`ogrenciKayitID`,`kursNo`,`ogrenciNo`,`not1`,`not2`,`ortalama`,`sonuc`,`devam`,`kayitTarihi`,`aciklama`) VALUES ( '57', '000042', '30682832620', '999', '999', '88', 'Başarılı', '99', '2011-08-21', 'Bilinmiyor' );
INSERT INTO `ogrencikayit`(`ogrenciKayitID`,`kursNo`,`ogrenciNo`,`not1`,`not2`,`ortalama`,`sonuc`,`devam`,`kayitTarihi`,`aciklama`) VALUES ( '67', '000001', '00000000001', '999', '999', '999', 'Girmedi', '99', '2011-08-21', 'Bilinmiyor' );
INSERT INTO `ogrencikayit`(`ogrenciKayitID`,`kursNo`,`ogrenciNo`,`not1`,`not2`,`ortalama`,`sonuc`,`devam`,`kayitTarihi`,`aciklama`) VALUES ( '94', '000039', '10000000012', '999', '999', '50', 'Başarısız', '99', '2011-08-21', 'Bilinmiyor' );
INSERT INTO `ogrencikayit`(`ogrenciKayitID`,`kursNo`,`ogrenciNo`,`not1`,`not2`,`ortalama`,`sonuc`,`devam`,`kayitTarihi`,`aciklama`) VALUES ( '99', '000001', '10000000010', '999', '999', '999', NULL, '99', '2011-08-21', 'Bilinmiyor' );
INSERT INTO `ogrencikayit`(`ogrenciKayitID`,`kursNo`,`ogrenciNo`,`not1`,`not2`,`ortalama`,`sonuc`,`devam`,`kayitTarihi`,`aciklama`) VALUES ( '100', '000001', '10000000005', '999', '999', '999', NULL, '99', '2011-08-21', 'Bilinmiyor' );
INSERT INTO `ogrencikayit`(`ogrenciKayitID`,`kursNo`,`ogrenciNo`,`not1`,`not2`,`ortalama`,`sonuc`,`devam`,`kayitTarihi`,`aciklama`) VALUES ( '163', '000046', '00000000061', '999', '999', '999', NULL, NULL, '2011-09-12', 'Bilinmiyor' );
INSERT INTO `ogrencikayit`(`ogrenciKayitID`,`kursNo`,`ogrenciNo`,`not1`,`not2`,`ortalama`,`sonuc`,`devam`,`kayitTarihi`,`aciklama`) VALUES ( '165', '000048', '00000000008', '999', '999', '999', NULL, NULL, '2011-09-12', 'Bilinmiyor' );
INSERT INTO `ogrencikayit`(`ogrenciKayitID`,`kursNo`,`ogrenciNo`,`not1`,`not2`,`ortalama`,`sonuc`,`devam`,`kayitTarihi`,`aciklama`) VALUES ( '166', '000048', '00000000041', '999', '999', '999', NULL, NULL, '2011-09-12', 'Bilinmiyor' );
INSERT INTO `ogrencikayit`(`ogrenciKayitID`,`kursNo`,`ogrenciNo`,`not1`,`not2`,`ortalama`,`sonuc`,`devam`,`kayitTarihi`,`aciklama`) VALUES ( '168', '000042', '00000000061', '999', '999', '111', 'Devamsız', NULL, '2011-09-12', 'Bilinmiyor' );
INSERT INTO `ogrencikayit`(`ogrenciKayitID`,`kursNo`,`ogrenciNo`,`not1`,`not2`,`ortalama`,`sonuc`,`devam`,`kayitTarihi`,`aciklama`) VALUES ( '245', '000048', '10000000010', '999', '999', '999', NULL, NULL, '2011-09-16', 'Bilinmiyor' );
INSERT INTO `ogrencikayit`(`ogrenciKayitID`,`kursNo`,`ogrenciNo`,`not1`,`not2`,`ortalama`,`sonuc`,`devam`,`kayitTarihi`,`aciklama`) VALUES ( '246', '000048', '10000000009', '999', '999', '999', NULL, NULL, '2011-09-16', 'Bilinmiyor' );
INSERT INTO `ogrencikayit`(`ogrenciKayitID`,`kursNo`,`ogrenciNo`,`not1`,`not2`,`ortalama`,`sonuc`,`devam`,`kayitTarihi`,`aciklama`) VALUES ( '272', '000038', '10000000008', '999', '999', '111', 'Devamsız', NULL, '2011-09-16', 'Bilinmiyor' );
INSERT INTO `ogrencikayit`(`ogrenciKayitID`,`kursNo`,`ogrenciNo`,`not1`,`not2`,`ortalama`,`sonuc`,`devam`,`kayitTarihi`,`aciklama`) VALUES ( '274', '000038', '10000000007', '999', '999', '50', 'Başarısız', NULL, '2011-09-16', 'Bilinmiyor' );
INSERT INTO `ogrencikayit`(`ogrenciKayitID`,`kursNo`,`ogrenciNo`,`not1`,`not2`,`ortalama`,`sonuc`,`devam`,`kayitTarihi`,`aciklama`) VALUES ( '275', '000038', '10000000010', '999', '999', '70', 'Başarılı', NULL, '2011-09-16', 'Bilinmiyor' );
INSERT INTO `ogrencikayit`(`ogrenciKayitID`,`kursNo`,`ogrenciNo`,`not1`,`not2`,`ortalama`,`sonuc`,`devam`,`kayitTarihi`,`aciklama`) VALUES ( '277', '000038', '10000000005', '999', '999', '80', 'Başarılı', NULL, '2011-09-16', 'Bilinmiyor' );
INSERT INTO `ogrencikayit`(`ogrenciKayitID`,`kursNo`,`ogrenciNo`,`not1`,`not2`,`ortalama`,`sonuc`,`devam`,`kayitTarihi`,`aciklama`) VALUES ( '278', '000038', '10000000002', '999', '999', '90', 'Başarılı', NULL, '2011-09-16', 'Bilinmiyor' );
INSERT INTO `ogrencikayit`(`ogrenciKayitID`,`kursNo`,`ogrenciNo`,`not1`,`not2`,`ortalama`,`sonuc`,`devam`,`kayitTarihi`,`aciklama`) VALUES ( '279', '000038', '00000000001', '999', '999', '80', 'Başarılı', NULL, '2011-09-16', 'Bilinmiyor' );
INSERT INTO `ogrencikayit`(`ogrenciKayitID`,`kursNo`,`ogrenciNo`,`not1`,`not2`,`ortalama`,`sonuc`,`devam`,`kayitTarihi`,`aciklama`) VALUES ( '280', '000038', '00000000008', '999', '999', '10', 'Başarısız', NULL, '2011-09-16', 'Bilinmiyor' );
INSERT INTO `ogrencikayit`(`ogrenciKayitID`,`kursNo`,`ogrenciNo`,`not1`,`not2`,`ortalama`,`sonuc`,`devam`,`kayitTarihi`,`aciklama`) VALUES ( '285', '000038', '10000000001', '999', '999', '90', 'Başarılı', NULL, '2011-09-16', 'Bilinmiyor' );
INSERT INTO `ogrencikayit`(`ogrenciKayitID`,`kursNo`,`ogrenciNo`,`not1`,`not2`,`ortalama`,`sonuc`,`devam`,`kayitTarihi`,`aciklama`) VALUES ( '289', '000038', '00000000021', '999', '999', '20', 'Başarısız', NULL, '2011-09-16', 'Bilinmiyor' );
INSERT INTO `ogrencikayit`(`ogrenciKayitID`,`kursNo`,`ogrenciNo`,`not1`,`not2`,`ortalama`,`sonuc`,`devam`,`kayitTarihi`,`aciklama`) VALUES ( '290', '000038', '00000000062', '999', '999', '30', 'Başarısız', NULL, '2011-09-16', 'Bilinmiyor' );
INSERT INTO `ogrencikayit`(`ogrenciKayitID`,`kursNo`,`ogrenciNo`,`not1`,`not2`,`ortalama`,`sonuc`,`devam`,`kayitTarihi`,`aciklama`) VALUES ( '291', '000038', '00000000003', '999', '999', '40', 'Başarısız', NULL, '2011-09-16', 'Bilinmiyor' );
INSERT INTO `ogrencikayit`(`ogrenciKayitID`,`kursNo`,`ogrenciNo`,`not1`,`not2`,`ortalama`,`sonuc`,`devam`,`kayitTarihi`,`aciklama`) VALUES ( '293', '000038', '10000000012', '999', '999', '111', 'Devamsız', NULL, '2011-09-16', 'Bilinmiyor' );
INSERT INTO `ogrencikayit`(`ogrenciKayitID`,`kursNo`,`ogrenciNo`,`not1`,`not2`,`ortalama`,`sonuc`,`devam`,`kayitTarihi`,`aciklama`) VALUES ( '294', '000038', '00000000004', '999', '999', '999', 'Girmedi', NULL, '2011-09-16', 'Bilinmiyor' );
INSERT INTO `ogrencikayit`(`ogrenciKayitID`,`kursNo`,`ogrenciNo`,`not1`,`not2`,`ortalama`,`sonuc`,`devam`,`kayitTarihi`,`aciklama`) VALUES ( '297', '000038', '30682832620', '999', '999', '999', 'Girmedi', NULL, '2011-09-16', 'Bilinmiyor' );
INSERT INTO `ogrencikayit`(`ogrenciKayitID`,`kursNo`,`ogrenciNo`,`not1`,`not2`,`ortalama`,`sonuc`,`devam`,`kayitTarihi`,`aciklama`) VALUES ( '299', '000038', '00000000009', '999', '999', '999', 'Girmedi', NULL, '2011-09-16', 'Bilinmiyor' );
INSERT INTO `ogrencikayit`(`ogrenciKayitID`,`kursNo`,`ogrenciNo`,`not1`,`not2`,`ortalama`,`sonuc`,`devam`,`kayitTarihi`,`aciklama`) VALUES ( '300', '000038', '00000000041', '999', '999', '999', 'Girmedi', NULL, '2011-09-16', 'Bilinmiyor' );
INSERT INTO `ogrencikayit`(`ogrenciKayitID`,`kursNo`,`ogrenciNo`,`not1`,`not2`,`ortalama`,`sonuc`,`devam`,`kayitTarihi`,`aciklama`) VALUES ( '306', '000038', '10000000006', '999', '999', '999', 'Girmedi', NULL, '2011-09-16', 'Bilinmiyor' );
INSERT INTO `ogrencikayit`(`ogrenciKayitID`,`kursNo`,`ogrenciNo`,`not1`,`not2`,`ortalama`,`sonuc`,`devam`,`kayitTarihi`,`aciklama`) VALUES ( '307', '000050', '00000000061', '999', '999', '20', 'Başarısız', NULL, '2011-09-16', 'Bilinmiyor' );
INSERT INTO `ogrencikayit`(`ogrenciKayitID`,`kursNo`,`ogrenciNo`,`not1`,`not2`,`ortalama`,`sonuc`,`devam`,`kayitTarihi`,`aciklama`) VALUES ( '308', '000050', '10000000011', '999', '999', '30', 'Başarısız', NULL, '2011-09-16', 'Bilinmiyor' );
INSERT INTO `ogrencikayit`(`ogrenciKayitID`,`kursNo`,`ogrenciNo`,`not1`,`not2`,`ortalama`,`sonuc`,`devam`,`kayitTarihi`,`aciklama`) VALUES ( '309', '000050', '10000000008', '999', '999', '40', 'Başarısız', NULL, '2011-09-16', 'Bilinmiyor' );
INSERT INTO `ogrencikayit`(`ogrenciKayitID`,`kursNo`,`ogrenciNo`,`not1`,`not2`,`ortalama`,`sonuc`,`devam`,`kayitTarihi`,`aciklama`) VALUES ( '310', '000050', '10000000010', '999', '999', '72', 'Başarılı', NULL, '2011-09-16', 'Bilinmiyor' );
INSERT INTO `ogrencikayit`(`ogrenciKayitID`,`kursNo`,`ogrenciNo`,`not1`,`not2`,`ortalama`,`sonuc`,`devam`,`kayitTarihi`,`aciklama`) VALUES ( '311', '000050', '10000000004', '999', '999', '999', 'Girmedi', NULL, '2011-09-16', 'Bilinmiyor' );
INSERT INTO `ogrencikayit`(`ogrenciKayitID`,`kursNo`,`ogrenciNo`,`not1`,`not2`,`ortalama`,`sonuc`,`devam`,`kayitTarihi`,`aciklama`) VALUES ( '312', '000050', '10000000006', '999', '999', '83', 'Başarılı', NULL, '2011-09-16', 'Bilinmiyor' );
INSERT INTO `ogrencikayit`(`ogrenciKayitID`,`kursNo`,`ogrenciNo`,`not1`,`not2`,`ortalama`,`sonuc`,`devam`,`kayitTarihi`,`aciklama`) VALUES ( '313', '000050', '10000000007', '999', '999', '40', 'Başarısız', NULL, '2011-09-16', 'Bilinmiyor' );
INSERT INTO `ogrencikayit`(`ogrenciKayitID`,`kursNo`,`ogrenciNo`,`not1`,`not2`,`ortalama`,`sonuc`,`devam`,`kayitTarihi`,`aciklama`) VALUES ( '315', '000050', '10000000003', '999', '999', '55', 'Başarısız', NULL, '2011-09-16', 'Bilinmiyor' );
INSERT INTO `ogrencikayit`(`ogrenciKayitID`,`kursNo`,`ogrenciNo`,`not1`,`not2`,`ortalama`,`sonuc`,`devam`,`kayitTarihi`,`aciklama`) VALUES ( '318', '000050', '10000000001', '999', '999', '99', 'Başarılı', NULL, '2011-09-16', 'Bilinmiyor' );
INSERT INTO `ogrencikayit`(`ogrenciKayitID`,`kursNo`,`ogrenciNo`,`not1`,`not2`,`ortalama`,`sonuc`,`devam`,`kayitTarihi`,`aciklama`) VALUES ( '319', '000050', '10000000002', '999', '999', '99', 'Başarılı', NULL, '2011-09-16', 'Bilinmiyor' );
INSERT INTO `ogrencikayit`(`ogrenciKayitID`,`kursNo`,`ogrenciNo`,`not1`,`not2`,`ortalama`,`sonuc`,`devam`,`kayitTarihi`,`aciklama`) VALUES ( '320', '000050', '00000000001', '999', '999', '88', 'Başarılı', NULL, '2011-09-16', 'Bilinmiyor' );
INSERT INTO `ogrencikayit`(`ogrenciKayitID`,`kursNo`,`ogrenciNo`,`not1`,`not2`,`ortalama`,`sonuc`,`devam`,`kayitTarihi`,`aciklama`) VALUES ( '321', '000050', '00000000008', '999', '999', '88', 'Başarılı', NULL, '2011-09-16', 'Bilinmiyor' );
INSERT INTO `ogrencikayit`(`ogrenciKayitID`,`kursNo`,`ogrenciNo`,`not1`,`not2`,`ortalama`,`sonuc`,`devam`,`kayitTarihi`,`aciklama`) VALUES ( '322', '000050', '00000000041', '999', '999', '999', 'Girmedi', NULL, '2011-09-16', 'Bilinmiyor' );
INSERT INTO `ogrencikayit`(`ogrenciKayitID`,`kursNo`,`ogrenciNo`,`not1`,`not2`,`ortalama`,`sonuc`,`devam`,`kayitTarihi`,`aciklama`) VALUES ( '323', '000050', '00000000009', '999', '999', '999', 'Girmedi', NULL, '2011-09-16', 'Bilinmiyor' );
INSERT INTO `ogrencikayit`(`ogrenciKayitID`,`kursNo`,`ogrenciNo`,`not1`,`not2`,`ortalama`,`sonuc`,`devam`,`kayitTarihi`,`aciklama`) VALUES ( '324', '000050', '00000000021', '999', '999', '88', 'Başarılı', NULL, '2011-09-16', 'Bilinmiyor' );
INSERT INTO `ogrencikayit`(`ogrenciKayitID`,`kursNo`,`ogrenciNo`,`not1`,`not2`,`ortalama`,`sonuc`,`devam`,`kayitTarihi`,`aciklama`) VALUES ( '325', '000050', '00000000062', '999', '999', '99', 'Başarılı', NULL, '2011-09-16', 'Bilinmiyor' );
INSERT INTO `ogrencikayit`(`ogrenciKayitID`,`kursNo`,`ogrenciNo`,`not1`,`not2`,`ortalama`,`sonuc`,`devam`,`kayitTarihi`,`aciklama`) VALUES ( '326', '000050', '30682832620', '999', '999', '999', 'Girmedi', NULL, '2011-09-16', 'Bilinmiyor' );
INSERT INTO `ogrencikayit`(`ogrenciKayitID`,`kursNo`,`ogrenciNo`,`not1`,`not2`,`ortalama`,`sonuc`,`devam`,`kayitTarihi`,`aciklama`) VALUES ( '327', '000050', '00000000003', '999', '999', '15', 'Başarısız', NULL, '2011-09-16', 'Bilinmiyor' );
INSERT INTO `ogrencikayit`(`ogrenciKayitID`,`kursNo`,`ogrenciNo`,`not1`,`not2`,`ortalama`,`sonuc`,`devam`,`kayitTarihi`,`aciklama`) VALUES ( '328', '000050', '10000000012', '999', '999', '12', 'Başarısız', NULL, '2011-09-16', 'Bilinmiyor' );
INSERT INTO `ogrencikayit`(`ogrenciKayitID`,`kursNo`,`ogrenciNo`,`not1`,`not2`,`ortalama`,`sonuc`,`devam`,`kayitTarihi`,`aciklama`) VALUES ( '329', '000050', '00000000004', '999', '999', '111', 'Devamsız', NULL, '2011-09-16', 'Bilinmiyor' );
INSERT INTO `ogrencikayit`(`ogrenciKayitID`,`kursNo`,`ogrenciNo`,`not1`,`not2`,`ortalama`,`sonuc`,`devam`,`kayitTarihi`,`aciklama`) VALUES ( '330', '000044', '10000000009', '999', '999', '999', NULL, NULL, '2011-09-16', 'Bilinmiyor' );
INSERT INTO `ogrencikayit`(`ogrenciKayitID`,`kursNo`,`ogrenciNo`,`not1`,`not2`,`ortalama`,`sonuc`,`devam`,`kayitTarihi`,`aciklama`) VALUES ( '331', '000045', '10000000001', '999', '999', '999', NULL, NULL, '2011-09-19', 'Bilinmiyor' );
INSERT INTO `ogrencikayit`(`ogrenciKayitID`,`kursNo`,`ogrenciNo`,`not1`,`not2`,`ortalama`,`sonuc`,`devam`,`kayitTarihi`,`aciklama`) VALUES ( '332', '000045', '10000000002', '999', '999', '999', NULL, NULL, '2011-09-19', 'Bilinmiyor' );
INSERT INTO `ogrencikayit`(`ogrenciKayitID`,`kursNo`,`ogrenciNo`,`not1`,`not2`,`ortalama`,`sonuc`,`devam`,`kayitTarihi`,`aciklama`) VALUES ( '333', '000045', '00000000001', '999', '999', '999', NULL, NULL, '2011-09-19', 'Bilinmiyor' );
INSERT INTO `ogrencikayit`(`ogrenciKayitID`,`kursNo`,`ogrenciNo`,`not1`,`not2`,`ortalama`,`sonuc`,`devam`,`kayitTarihi`,`aciklama`) VALUES ( '334', '000048', '10000000003', '999', '999', '999', NULL, NULL, '2011-09-27', 'Bilinmiyor' );
INSERT INTO `ogrencikayit`(`ogrenciKayitID`,`kursNo`,`ogrenciNo`,`not1`,`not2`,`ortalama`,`sonuc`,`devam`,`kayitTarihi`,`aciklama`) VALUES ( '335', '000048', '10000000005', '999', '999', '999', NULL, NULL, '2011-09-27', 'Bilinmiyor' );
INSERT INTO `ogrencikayit`(`ogrenciKayitID`,`kursNo`,`ogrenciNo`,`not1`,`not2`,`ortalama`,`sonuc`,`devam`,`kayitTarihi`,`aciklama`) VALUES ( '336', '000048', '10000000001', '999', '999', '999', NULL, NULL, '2011-09-27', 'Bilinmiyor' );
INSERT INTO `ogrencikayit`(`ogrenciKayitID`,`kursNo`,`ogrenciNo`,`not1`,`not2`,`ortalama`,`sonuc`,`devam`,`kayitTarihi`,`aciklama`) VALUES ( '337', '000039', '10000000008', '999', '999', '999', NULL, NULL, '2011-09-27', 'Bilinmiyor' );
INSERT INTO `ogrencikayit`(`ogrenciKayitID`,`kursNo`,`ogrenciNo`,`not1`,`not2`,`ortalama`,`sonuc`,`devam`,`kayitTarihi`,`aciklama`) VALUES ( '338', '000039', '10000000010', '999', '999', '999', NULL, NULL, '2011-09-27', 'Bilinmiyor' );
INSERT INTO `ogrencikayit`(`ogrenciKayitID`,`kursNo`,`ogrenciNo`,`not1`,`not2`,`ortalama`,`sonuc`,`devam`,`kayitTarihi`,`aciklama`) VALUES ( '339', '000039', '10000000005', '999', '999', '999', NULL, NULL, '2011-09-27', 'Bilinmiyor' );
INSERT INTO `ogrencikayit`(`ogrenciKayitID`,`kursNo`,`ogrenciNo`,`not1`,`not2`,`ortalama`,`sonuc`,`devam`,`kayitTarihi`,`aciklama`) VALUES ( '340', '000039', '10000000001', '999', '999', '999', NULL, NULL, '2011-09-27', 'Bilinmiyor' );
INSERT INTO `ogrencikayit`(`ogrenciKayitID`,`kursNo`,`ogrenciNo`,`not1`,`not2`,`ortalama`,`sonuc`,`devam`,`kayitTarihi`,`aciklama`) VALUES ( '341', '000039', '10000000002', '999', '999', '999', NULL, NULL, '2011-09-27', 'Bilinmiyor' );
INSERT INTO `ogrencikayit`(`ogrenciKayitID`,`kursNo`,`ogrenciNo`,`not1`,`not2`,`ortalama`,`sonuc`,`devam`,`kayitTarihi`,`aciklama`) VALUES ( '342', '000039', '00000000021', '999', '999', '999', NULL, NULL, '2011-09-27', 'Bilinmiyor' );
INSERT INTO `ogrencikayit`(`ogrenciKayitID`,`kursNo`,`ogrenciNo`,`not1`,`not2`,`ortalama`,`sonuc`,`devam`,`kayitTarihi`,`aciklama`) VALUES ( '343', '000039', '00000000062', '999', '999', '999', NULL, NULL, '2011-09-27', 'Bilinmiyor' );
INSERT INTO `ogrencikayit`(`ogrenciKayitID`,`kursNo`,`ogrenciNo`,`not1`,`not2`,`ortalama`,`sonuc`,`devam`,`kayitTarihi`,`aciklama`) VALUES ( '347', '000052', '10000000005', '222', '222', '88', 'Başarılı', NULL, '2011-10-07', 'Bilinmiyor' );
INSERT INTO `ogrencikayit`(`ogrenciKayitID`,`kursNo`,`ogrenciNo`,`not1`,`not2`,`ortalama`,`sonuc`,`devam`,`kayitTarihi`,`aciklama`) VALUES ( '348', '000052', '00000000001', '222', '222', '99', 'Başarılı', NULL, '2011-10-07', 'Bilinmiyor' );
INSERT INTO `ogrencikayit`(`ogrenciKayitID`,`kursNo`,`ogrenciNo`,`not1`,`not2`,`ortalama`,`sonuc`,`devam`,`kayitTarihi`,`aciklama`) VALUES ( '353', '000052', '00000000008', '222', '222', '222', NULL, NULL, '2012-12-13', 'Bilinmiyor' );
INSERT INTO `ogrencikayit`(`ogrenciKayitID`,`kursNo`,`ogrenciNo`,`not1`,`not2`,`ortalama`,`sonuc`,`devam`,`kayitTarihi`,`aciklama`) VALUES ( '354', '000052', '00000000041', '222', '222', '222', NULL, NULL, '2012-12-13', 'Bilinmiyor' );
INSERT INTO `ogrencikayit`(`ogrenciKayitID`,`kursNo`,`ogrenciNo`,`not1`,`not2`,`ortalama`,`sonuc`,`devam`,`kayitTarihi`,`aciklama`) VALUES ( '355', '000052', '00000000061', '222', '222', '222', NULL, NULL, '2012-12-13', 'Bilinmiyor' );
INSERT INTO `ogrencikayit`(`ogrenciKayitID`,`kursNo`,`ogrenciNo`,`not1`,`not2`,`ortalama`,`sonuc`,`devam`,`kayitTarihi`,`aciklama`) VALUES ( '356', '000052', '10000000006', '222', '222', '222', NULL, NULL, '2012-12-13', 'Bilinmiyor' );
INSERT INTO `ogrencikayit`(`ogrenciKayitID`,`kursNo`,`ogrenciNo`,`not1`,`not2`,`ortalama`,`sonuc`,`devam`,`kayitTarihi`,`aciklama`) VALUES ( '362', '000052', '00000000062', '222', '222', '222', NULL, NULL, '2012-12-13', 'Bilinmiyor' );
INSERT INTO `ogrencikayit`(`ogrenciKayitID`,`kursNo`,`ogrenciNo`,`not1`,`not2`,`ortalama`,`sonuc`,`devam`,`kayitTarihi`,`aciklama`) VALUES ( '363', '000052', '10000000002', '222', '222', '222', NULL, NULL, '2012-12-13', 'Bilinmiyor' );
INSERT INTO `ogrencikayit`(`ogrenciKayitID`,`kursNo`,`ogrenciNo`,`not1`,`not2`,`ortalama`,`sonuc`,`devam`,`kayitTarihi`,`aciklama`) VALUES ( '365', '000052', '10000000011', '222', '222', '222', NULL, NULL, '2012-12-15', 'Bilinmiyor' );
-- ---------------------------------------------------------
...
-- CREATE INDEX "FK_acilankurslar" -------------------------
CREATE INDEX `FK_acilankurslar` USING BTREE ON `acilankurslar`( `kursNo` );
-- ---------------------------------------------------------


-- CREATE INDEX "FK_acilankurslarmerkezler" ----------------
CREATE INDEX `FK_acilankurslarmerkezler` USING BTREE ON `acilankurslar`( `merkezNo` );
-- ---------------------------------------------------------


-- CREATE INDEX "FK_acilankurslar_Personel" ----------------
CREATE INDEX `FK_acilankurslar_Personel` USING BTREE ON `acilankurslar`( `personelNo` );
-- ---------------------------------------------------------


-- CREATE INDEX "NewIndex1" --------------------------------
CREATE INDEX `NewIndex1` USING BTREE ON `acilankurslar`( `kursNo` );
-- ---------------------------------------------------------


-- CREATE INDEX "FK_dersprogrami" --------------------------
CREATE INDEX `FK_dersprogrami` USING BTREE ON `dersprogrami`( `acilanKursNo` );
-- ---------------------------------------------------------
...
-- CREATE INDEX "FK_ogrencikayitKurslar" -------------------
CREATE INDEX `FK_ogrencikayitKurslar` USING BTREE ON `ogrencikayit`( `kursNo` );
-- ---------------------------------------------------------
...
-- CREATE LINK "FK_acilankurslar" --------------------------
ALTER TABLE `acilankurslar`
	ADD CONSTRAINT `FK_acilankurslar` FOREIGN KEY ( `kursNo` )
	REFERENCES `kurskatalog`( `kursNo` )
	ON DELETE Restrict
	ON UPDATE Restrict;
-- ---------------------------------------------------------


-- CREATE LINK "FK_acilankurslarmerkezler" -----------------
ALTER TABLE `acilankurslar`
	ADD CONSTRAINT `FK_acilankurslarmerkezler` FOREIGN KEY ( `merkezNo` )
	REFERENCES `merkezler`( `merkezNo` )
	ON DELETE Restrict
	ON UPDATE Restrict;
-- ---------------------------------------------------------


-- CREATE LINK "FK_acilankurslar_personel" -----------------
ALTER TABLE `acilankurslar`
	ADD CONSTRAINT `FK_acilankurslar_personel` FOREIGN KEY ( `personelNo` )
...
ALTER TABLE `dersprogrami`
	ADD CONSTRAINT `FK_dersprogrami` FOREIGN KEY ( `acilanKursNo` )
	REFERENCES `acilankurslar`( `acilanKurslarID` )
	ON DELETE Restrict
	ON UPDATE Restrict;
-- ---------------------------------------------------------
...
-- CREATE LINK "FK_ogrencikayitKurslar" --------------------
ALTER TABLE `ogrencikayit`
	ADD CONSTRAINT `FK_ogrencikayitKurslar` FOREIGN KEY ( `kursNo` )
	REFERENCES `acilankurslar`( `acilanKurslarID` )
	ON DELETE Restrict
	ON UPDATE Restrict;
-- ---------------------------------------------------------
